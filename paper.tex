...
$N = 64$ ($m = 6$ qubits). All counts are after Qiskit
transpilation to $\{$CX, U, X, H$\}$ at optimisation
level~2. The Shende column applies
\texttt{StatePreparation}~\cite{shende2006} to the
\emph{same} vector as PyEncode in each row.

\begin{table}[ht]
\centering
\caption{Transpiled gate counts at $N=64$ ($m=6$),
basis $\{CX, U, X, H\}$, Qiskit optimisation level~2.}
...
Sin ($n\!=\!1$, $\varphi\!=\!0$)
    &  73 & $\mathcal{O}(m^2)$  & 120 & $\mathcal{O}(2^m)$ \\
Sin ($n\!=\!3$, $\varphi\!=\!\pi/4$)
    &  75 & $\mathcal{O}(m^2)$  & 120 & $\mathcal{O}(2^m)$ \\
Cos ($n\!=\!1$, $\varphi\!=\!0$)
    &  73 & $\mathcal{O}(m^2)$  & 120 & $\mathcal{O}(2^m)$ \\
Cos ($n\!=\!3$, $\varphi\!=\!\pi/4$)
    &  75 & $\mathcal{O}(m^2)$  & 120 & $\mathcal{O}(2^m)$ \\
Multi-discrete ($|S|\!=\!2$)
    &   6 & $\mathcal{O}(|S|m)$ &  42 & $\mathcal{O}(2^m)$ \\
\bottomrule
\end{tabular*}
\end{table}
