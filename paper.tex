...
\section{Gate Count}
\label{sec:gateCount}
Table~\ref{tab:gatecounts} summarizes gate counts at
$N = 64$ ($m = 6$ qubits). The ``raw'' columns show gate
counts directly from PyEncode's synthesiser and from Qiskit's
\texttt{StatePreparation}~\cite{shende2006} (applied to the same
vector). The ``transpiled'' columns show the counts after
Qiskit transpilation to $\{$CX, U, X, H$\}$ at
optimisation level~2; transpilation further reduces PyEncode's
circuits but cannot improve Shende's already-optimal decomposition.

\begin{table}[ht]
\centering
\caption{Gate counts at $N=64$ ($m=6$). Raw: direct output
of each synthesiser. Transpiled: after Qiskit transpilation
to $\{CX, U, X, H\}$ at optimisation level~2.}
\label{tab:gatecounts}
\setlength{\tabcolsep}{2.5pt}
\renewcommand{\arraystretch}{1.15}
\begin{tabular*}{\columnwidth}{@{\extracolsep{\fill}}lrrrlrl@{}}
\toprule
 & \multicolumn{3}{c}{\textbf{PyEncode}}
 & & \multicolumn{2}{c}{\textbf{Shende}} \\
\cmidrule(lr){2-4}\cmidrule(lr){6-7}
\textbf{Pattern} & Raw & Transp. & $\mathcal{O}(\cdot)$
                 & & Gates & $\mathcal{O}(\cdot)$ \\
\midrule
Discrete ($k\!=\!20$)
    &   2 &   2 & $\mathcal{O}(m)$    & &  18 & $\mathcal{O}(2^m)$ \\
Uniform
    &   6 &   6 & $\mathcal{O}(m)$    & &   6 & $\mathcal{O}(2^m)$ \\
Step ($k_s\!=\!4$)
    &   2 &   2 & $\mathcal{O}(m)$    & &  62 & $\mathcal{O}(2^m)$ \\
Square ($[8,16)$)
    &   4 &   4 & $\mathcal{O}(m)$    & &  52 & $\mathcal{O}(2^m)$ \\
Sin ($n\!=\!1$, $\varphi\!=\!0$)
    & 100 &  73 & $\mathcal{O}(m^2)$  & & 120 & $\mathcal{O}(2^m)$ \\
Sin ($n\!=\!3$, $\varphi\!=\!\pi/4$)
    & 102 &  75 & $\mathcal{O}(m^2)$  & & 120 & $\mathcal{O}(2^m)$ \\
Cos ($n\!=\!1$, $\varphi\!=\!0$)
    & 100 &  73 & $\mathcal{O}(m^2)$  & & 120 & $\mathcal{O}(2^m)$ \\
Cos ($n\!=\!3$, $\varphi\!=\!\pi/4$)
    & 102 &  75 & $\mathcal{O}(m^2)$  & & 120 & $\mathcal{O}(2^m)$ \\
Multi-discrete ($|S|\!=\!2$)
    &   9 &   6 & $\mathcal{O}(|S|m)$ & &  42 & $\mathcal{O}(2^m)$ \\
\bottomrule
\end{tabular*}
\end{table}
